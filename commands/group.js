...
cmd({
        pattern: "support",
        desc: "Sends AKENO userbot group link.",
        category: "group",
    },
    async(Void, citel, text) => {
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            memek = await Void.sendImageAsSticker(citel.chat, meme, citel, { packname: citel.pushName, author: 'Akeno' })
